...
| :--- | :--- | :--- |
| **Internal Dataset** | High-resolution labeled perovskite SEM images for model training and baseline validation. | [👉 Download Link XX](https://your-link-here) |
| **Robustness Stress Test** | Systematically degraded SEM images (blur, downsampling, and contrast attenuation) to evaluate model generalization. | [👉 Download Link XX](https://your-link-here) |
